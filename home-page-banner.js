...
function initAppLogic() {
    ...
    bannerForm.addEventListener("submit", async (e) => {
        ...
        if (clickLink && !validateClickLink(clickLink)) {
...
function validateClickLink(string) {
    try {
        new URL(string);
        return true;
    } catch (_) {
...
async function createBanner() {
    ...
    try {
        ...
        await addDoc(collection(db, "home_banner"), {
...
function renderBannerCard(id, data) {
    ...
    const clickLinkDisplay = data.clickLink ? `<a href="${data.clickLink}" target="_blank">${data.clickLink}</a>` : "লিংক নেই";
    ...
    card.innerHTML = `
        ...
        <div class="banner-card-body">
            <p class="banner-link-text">লিংক: ${clickLinkDisplay}</p>
    ...
    card.querySelector(".copy-btn").addEventListener("click", (e) => {
        ...
        copyBannerJson(jsonString);
    });

    card.querySelector(".edit-btn").addEventListener("click", (e) => {
        const btn = e.currentTarget;
        editBanner(btn.getAttribute("data-id"), btn.getAttribute("data-link"), btn.getAttribute("data-img"));
    });
...
function editBanner(id, link, imgUrl) {
    currentEditingId = id;
...
async function updateBanner(id) {
    ...
    try {
        ...
        const clickLink = clickLinkInput.value.trim();
        const docRef = doc(db, "home_banner", id);
...
async function deleteBanner(id) {
    try {
        ...
        await deleteDoc(doc(db, "home_banner", id));
        hideLoading();
